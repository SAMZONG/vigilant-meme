...
# WARNING: Ensure imports from `vigilant_meme` comes after this line
from vigilant_meme import app, settings, db  # noqa
from vigilant_meme.cli import create_user, cli  # noqa
